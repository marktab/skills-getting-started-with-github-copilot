document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Keep only the placeholder option before repopulating activities.
      ...
      // Wire delete actions after rendering cards.
      const deleteButtons = document.querySelectorAll(".delete-participant-btn");
      deleteButtons.forEach((button) => {
        button.addEventListener("click", async (event) => {
          const clickedButton = event.currentTarget;
          const email = clickedButton.dataset.email;
          const activity = clickedButton.dataset.activity;
